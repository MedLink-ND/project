...
urlpatterns = [
    ...
    url(r'hospital/hospital_job_details/(?P<job_id>\d+)/reject/(?P<worker_id>\d+)/$', views.hospital_reject_applicant, name="reject"),
    url(r'hospital/hospital_job_details/(?P<job_id>\d+)/accept/(?P<worker_id>\d+)/$', views.hospital_accept_applicant, name="accept"),
